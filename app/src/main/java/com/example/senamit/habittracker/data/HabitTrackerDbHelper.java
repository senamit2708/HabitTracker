...
public class HabitTrackerDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTERIES = "CREATE TABLE " + Habitentry.TABLE_NAME+"(" +Habitentry._ID+ " INTEGER PRIMARY KEY,"+
            Habitentry.COLUMN_HABIT_NAME+ " TEXT,"+ Habitentry.COLUMN_NUMBER_OF_DAYS+ " TEXT NOT NULL)";
